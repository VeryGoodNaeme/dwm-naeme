...
static const char *fonts[]          = { "monospace:size=10", "FontAwesome:size=9" };
...
static const char col_text[]        = "#fdf6e3";
static const char col_base[]	    = "#073642";
...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray4, col_gray1, col_base01 },
	[SchemeSel]  = { col_text, col_cyan,  col_cyan  },
};
